...
\newcommand{\rvec}[1]{\left[\begin{array}{c c} #1 \end{array} \right]}
...
\section{Неделя 1: Равновесие. Принцип виртуальных перемещений.}
\import{src/}{1_week.tex}

\section{Неделя 2: Прямой метод Ляпунова в теории устойчивости движения.}
\import{src/}{2_week.tex}
